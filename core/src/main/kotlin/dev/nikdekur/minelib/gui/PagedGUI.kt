...
abstract class PagedGUI(
    ...
    size: Int,
    var page: Int = 0
) : GUI(playerContext, size) {

    open val previousArrowPos: Int = 45
    open val nextArrowPos: Int = 53

    open val previousArrow: ItemStack = Patterns.ARROW_PREVIOUS.build(playerContext.localeProvider, player)
    open val nextArrow: ItemStack = Patterns.ARROW_NEXT.build(playerContext.localeProvider, player)
