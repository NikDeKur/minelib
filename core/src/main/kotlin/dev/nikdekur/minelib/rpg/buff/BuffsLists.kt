...
interface BuffsList : Iterable<RPGBuffData> {
    ...
    fun <T : Comparable<T>> getBuffs(type: RPGStat<T>): Collection<RPGBuffData>
    fun <T : Comparable<T>> getBuff(type: RPGStat<T>, id: UUID): RPGBuffData?
    ...
    object Empty : BuffsList {
        override fun <T : Comparable<T>> getBuffs(type: RPGStat<T>): Collection<RPGBuffData> = emptyList()
        override fun <T : Comparable<T>> getBuff(type: RPGStat<T>, id: UUID): RPGBuffData? = null
