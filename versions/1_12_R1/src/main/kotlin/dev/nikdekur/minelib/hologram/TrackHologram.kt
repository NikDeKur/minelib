...
import dev.nikdekur.minelib.pentity.TrackerPersonalEntity
...
abstract class TrackHologram(manager: PersonalEntityManager) : TrackerPersonalEntity(manager), Hologram {
    ...
    val trackerFactory = dev.nikdekur.minelib.nms.track.PersonalTrackerEntry.Companion.factory(dev.nikdekur.minelib.nms.entity.MineEntityType.ARMOR_STAND)
    ...
    override fun update(player: Player) {
        ...
        entities.forEachIndexed { index, entity ->
            ...
            if (entity.customName != line) {
                entity.customName = line
                dev.nikdekur.minelib.nms.packet.PacketBuilder.Entity.Data.updateShort(entity).send(player)
            }
        }
    }
