...
import dev.nikdekur.minelib.ext.newNMSInstance
...
import dev.nikdekur.minelib.pentity.ServerPersonalEntityManagerImpl
...
object VersionAdapter_1_12_R1 : VersionAdapter {
    ...
    override fun getServerPersonalEntityManager(): ServerPersonalEntityManager {
        return ServerPersonalEntityManagerImpl
    }

    override fun getProtocolModule(): ProtocolModule {
        return InjectProtocolModule
    }
